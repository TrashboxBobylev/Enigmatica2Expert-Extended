...
static hardnessConflicts as int[IBlockDefinition] = {} as int[IBlockDefinition];
...
set(3, 'pickaxe', <thermalfoundation:storage_alloy:1>, 4);
...
set(6, 'pickaxe', <extendedcrafting:storage:5>, 18);
